...
5. You will communicate mathematical arguments, experiments, and code in a professional format via the $\LaTeX$ mathematical markup language. 
...
3. In order to access recorded content, you need to **ask me for access.**
